...
const X3Store = {
  ...
  defaults() {
    return {
      account: {
        user: 'adamowen',
        domain: 'adamowen.co.uk',
        email: 'adam@adamowen.co.uk',
        contact: 'adam@adamowen.co.uk',
      ...
      emails: [
        { id: 1, user: 'adam',    domain: 'adamowen.co.uk', quota: 1000, used: 142.5, status: 'active',  forward: '' },
        { id: 2, user: 'info',    domain: 'adamowen.co.uk', quota: 500,  used: 87.2,  status: 'active',  forward: '' },
        { id: 3, user: 'support', domain: 'adamowen.co.uk', quota: 500,  used: 12.0,  status: 'active',  forward: 'adam@adamowen.co.uk' },
        { id: 4, user: 'billing', domain: 'adamowen.co.uk', quota: 250,  used: 0.4,   status: 'suspended', forward: '' },
      ],
      forwarders: [
        { id: 1, from: 'support@adamowen.co.uk', to: 'adam@adamowen.co.uk', status: 'active' },
        { id: 2, from: 'webmaster@adamowen.co.uk', to: 'adam@adamowen.co.uk', status: 'active' },
      ],
      autoresponders: [
        { id: 1, email: 'info@adamowen.co.uk', subject: 'Teşekkürler', body: 'Mesajınız alındı, en kısa sürede dönüş yapacağız.', status: 'active' },
      ],
      mailFilters: [
        { id: 1, name: 'Spam engelle', rules: 'Konu "viagra" içeriyor → Sil', status: 'active' },
      ],
      ftpAccounts: [
        { id: 1, user: 'ftpuser1', dir: '/home/adamowen/public_html', quota: 1024, used: 210, status: 'active' },
      ],
      files: [
      ...
      databases: [
        { id: 1, name: 'adamowen_blog',    user: 'adamowen_admin', size: '12.4 MB', collation: 'utf8mb4_general_ci', tables: 24 },
        { id: 2, name: 'adamowen_portal',  user: 'adamowen_admin', size: '2.10 MB', collation: 'utf8mb4_general_ci', tables: 8 },
      ],
      dbUsers: [
        { id: 1, user: 'adamowen_admin', host: 'localhost', priv: 'ALL PRIVILEGES' },
      ],
      subdomains: [
        { id: 1, prefix: 'blog',  domain: 'adamowen.co.uk', root: '/home/adamowen/public_html/blog',  redirect: '', status: 'active' },
        { id: 2, prefix: 'shop',  domain: 'adamowen.co.uk', root: '/home/adamowen/public_html/shop',  redirect: '', status: 'active' },
        { id: 3, prefix: 'mail',  domain: 'adamowen.co.uk', root: '/home/adamowen/public_html',        redirect: 'mail.adamowen.co.uk', status: 'active' },
      ],
      addonDomains: [
        { id: 1, domain: 'adamowen.net', root: '/home/adamowen/public_html/net', redirect: '', status: 'active' },
      ],
      aliases: [
        { id: 1, domain: 'adamowen.org', redirect: 'adamowen.co.uk', status: 'active' },
      ],
      redirects: [
        { id: 1, from: '/old-page', to: 'https://adamowen.co.uk/new-page', type: '301', status: 'active' },
      ],
      dnsRecords: [
        { id: 1, type: 'A',     name: '@',    ttl: '14400', value: '185.199.108.153',   priority: '' },
        { id: 2, type: 'CNAME', name: 'www',  ttl: '14400', value: 'adamowen.co.uk',     priority: '' },
        { id: 3, type: 'MX',    name: '@',    ttl: '14400', value: 'mail.adamowen.co.uk', priority: '10' },
        { id: 4, type: 'TXT',   name: '@',    ttl: '14400', value: 'v=spf1 include:spf.adamowen.co.uk ~all', priority: '' },
        { id: 5, type: 'TXT',   name: 'default._domainkey', ttl: '14400', value: 'v=DKIM1; k=rsa; p=MIGfMA0G...', priority: '' },
        { id: 6, type: 'CNAME', name: 'blog', ttl: '14400', value: 'adamowen.co.uk', priority: '' },
      ],
      cronJobs: [
        { id: 1, minute: '0',  hour: '3', day: '*', month: '*', weekday: '*', cmd: '/usr/bin/php /home/adamowen/public_html/cron.php', status: 'active' },
      ...
      ssl: {
        ...
        expires: '2024-06-15',
        certs: [
          { domain: 'adamowen.co.uk',      status: 'active', expires: '2024-06-15' },
          { domain: 'www.adamowen.co.uk',  status: 'active', expires: '2024-06-15' },
          { domain: 'blog.adamowen.co.uk', status: 'active', expires: '2024-06-15' },
        ],
      },
      ipBlocker: [
      ...
      hotlinkProtected: { enabled: true, urls: ['https://adamowen.co.uk'], extensions: ['jpg', 'png', 'gif'] },
      ...
      errorLogs: [
        { date: '2024-04-01', time: '14:11:30', type: 'error',   msg: '[client 31.223.4.77] File does not exist: /home/adamowen/public_html/404.html' },
      ...
      processes: [
        { pid: 1821, user: 'adamowen', cpu: '0.5%', mem: '1.2%', cmd: '/usr/local/bin/php /home/adamowen/public_html/cron.php' },
        { pid: 2011, user: 'adamowen', cpu: '0.1%', mem: '0.8%', cmd: '/usr/sbin/apache2 -k start' },
      ],
      tasks: [
